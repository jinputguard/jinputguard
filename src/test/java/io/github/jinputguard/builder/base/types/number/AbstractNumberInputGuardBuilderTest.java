	...
	class Sanitization {
		...
		class Clamp {
			...
			void clamp_MIN_MIN() {
				...
				GuardResultAssert.assertThat(guard.process(getMinValue())).as("clamp(MIN, MIN) & MIN = MIN").isSuccess(getMinValue());
				GuardResultAssert.assertThat(guard.process(getMinusOne())).as("clamp(MIN, MIN) & -1 = MIN").isSuccess(getMinValue());
				GuardResultAssert.assertThat(guard.process(getZero())).as("clamp(MIN, MIN) & 0 = MIN").isSuccess(getMinValue());
				GuardResultAssert.assertThat(guard.process(getOne())).as("clamp(MIN, MIN) & 1 = MIN").isSuccess(getMinValue());
				GuardResultAssert.assertThat(guard.process(getMaxValue())).as("clamp(MIN, MIN) & MAX = MIN").isSuccess(getMinValue());
			}

			@Test
			void clamp_MIN_MinusOne() {
				var guard = initiateGuard().sanitize().clamp(getMinValue(), getMinusOne()).then().build();
				GuardResultAssert.assertThat(guard.process(getMinValue())).as("clamp(MIN, -1) & MIN = MIN").isSuccess(getMinValue());
				GuardResultAssert.assertThat(guard.process(getMinusOne())).as("clamp(MIN, -1) & -1 = -1").isSuccess(getMinusOne());
				GuardResultAssert.assertThat(guard.process(getZero())).as("clamp(MIN, -1) & 0 = -1").isSuccess(getMinusOne());
				GuardResultAssert.assertThat(guard.process(getOne())).as("clamp(MIN, -1) & 1 = -1").isSuccess(getMinusOne());
				GuardResultAssert.assertThat(guard.process(getMaxValue())).as("clamp(MIN, -1) & MAX = -1").isSuccess(getMinusOne());
			}

			@Test
			void clamp_MIN_Zero() {
				var guard = initiateGuard().sanitize().clamp(getMinValue(), getZero()).then().build();
				GuardResultAssert.assertThat(guard.process(getMinValue())).as("clamp(MIN, 0) & MIN = MIN").isSuccess(getMinValue());
				GuardResultAssert.assertThat(guard.process(getMinusOne())).as("clamp(MIN, 0) & -1 = -1").isSuccess(getMinusOne());
				GuardResultAssert.assertThat(guard.process(getZero())).as("clamp(MIN, 0) & 0 = 0").isSuccess(getZero());
				GuardResultAssert.assertThat(guard.process(getOne())).as("clamp(MIN, 0) & 1 = 0").isSuccess(getZero());
				GuardResultAssert.assertThat(guard.process(getMaxValue())).as("clamp(MIN, 0) & MAX = 0").isSuccess(getZero());
			}
			...
			void clamp_MIN_One() {
				...
				GuardResultAssert.assertThat(guard.process(getMinValue())).as("clamp(MIN, 1) & MIN = MIN").isSuccess(getMinValue());
				GuardResultAssert.assertThat(guard.process(getMinusOne())).as("clamp(MIN, 1) & -1 = -1").isSuccess(getMinusOne());
				GuardResultAssert.assertThat(guard.process(getZero())).as("clamp(MIN, 1) & 0 = 0").isSuccess(getZero());
				GuardResultAssert.assertThat(guard.process(getOne())).as("clamp(MIN, 1) & 1 = 1").isSuccess(getOne());
				GuardResultAssert.assertThat(guard.process(getMaxValue())).as("clamp(MIN, 1) & MAX = 1").isSuccess(getOne());
			}

			@Test
			void clamp_MIN_MAX() {
				var guard = initiateGuard().sanitize().clamp(getMinValue(), getMaxValue()).then().build();
				GuardResultAssert.assertThat(guard.process(getMinValue())).as("clamp(MIN, MAX) & MIN = MIN").isSuccess(getMinValue());
				GuardResultAssert.assertThat(guard.process(getMinusOne())).as("clamp(MIN, MAX) & -1 = -1").isSuccess(getMinusOne());
				GuardResultAssert.assertThat(guard.process(getZero())).as("clamp(MIN, MAX) & 0 = 0").isSuccess(getZero());
				GuardResultAssert.assertThat(guard.process(getOne())).as("clamp(MIN, MAX) & 1 = 1").isSuccess(getOne());
				GuardResultAssert.assertThat(guard.process(getMaxValue())).as("clamp(MIN, MAX) & MAX = MAX").isSuccess(getMaxValue());
			}

			@Test
			void clamp_MinusOne_MinusOne() {
				var guard = initiateGuard().sanitize().clamp(getMinusOne(), getMinusOne()).then().build();
				GuardResultAssert.assertThat(guard.process(getMinValue())).as("clamp(-1, -1) & MIN = -1").isSuccess(getMinusOne());
				GuardResultAssert.assertThat(guard.process(getMinusOne())).as("clamp(-1, -1) & -1 = -1").isSuccess(getMinusOne());
				GuardResultAssert.assertThat(guard.process(getZero())).as("clamp(-1, -1) & 0 = -1").isSuccess(getMinusOne());
				GuardResultAssert.assertThat(guard.process(getOne())).as("clamp(-1, -1) & 1 = -1").isSuccess(getMinusOne());
				GuardResultAssert.assertThat(guard.process(getMaxValue())).as("clamp(-1, -1) & MAX = -1").isSuccess(getMinusOne());
			}

			@Test
			void clamp_MinusOne_Zero() {
				var guard = initiateGuard().sanitize().clamp(getMinusOne(), getZero()).then().build();
				GuardResultAssert.assertThat(guard.process(getMinValue())).as("clamp(-1, 0) & MIN = -1").isSuccess(getMinusOne());
				GuardResultAssert.assertThat(guard.process(getMinusOne())).as("clamp(-1, 0) & -1 = -1").isSuccess(getMinusOne());
				GuardResultAssert.assertThat(guard.process(getZero())).as("clamp(-1, 0) & 0 = 0").isSuccess(getZero());
				GuardResultAssert.assertThat(guard.process(getOne())).as("clamp(-1, 0) & 1 = 0").isSuccess(getZero());
				GuardResultAssert.assertThat(guard.process(getMaxValue())).as("clamp(-1, 0) & MAX = 0").isSuccess(getZero());
			}
			...
			void clamp_MinusOne_One() {
				...
				GuardResultAssert.assertThat(guard.process(getMinValue())).as("clamp(-1, 1) & MIN = -1").isSuccess(getMinusOne());
				GuardResultAssert.assertThat(guard.process(getMinusOne())).as("clamp(-1, 1) & -1 = -1").isSuccess(getMinusOne());
				GuardResultAssert.assertThat(guard.process(getZero())).as("clamp(-1, 1) & 0 = 0").isSuccess(getZero());
				GuardResultAssert.assertThat(guard.process(getOne())).as("clamp(-1, 1) & 1 = 1").isSuccess(getOne());
				GuardResultAssert.assertThat(guard.process(getMaxValue())).as("clamp(-1, 1) & MAX = 1").isSuccess(getOne());
			}

			@Test
			void clamp_MinusOne_MAX() {
				var guard = initiateGuard().sanitize().clamp(getMinusOne(), getMaxValue()).then().build();
				GuardResultAssert.assertThat(guard.process(getMinValue())).as("clamp(-1, MAX) & MIN = -1").isSuccess(getMinusOne());
				GuardResultAssert.assertThat(guard.process(getMinusOne())).as("clamp(-1, MAX) & -1 = -1").isSuccess(getMinusOne());
				GuardResultAssert.assertThat(guard.process(getZero())).as("clamp(-1, MAX) & 0 = 0").isSuccess(getZero());
				GuardResultAssert.assertThat(guard.process(getOne())).as("clamp(-1, MAX) & 1 = 1").isSuccess(getOne());
				GuardResultAssert.assertThat(guard.process(getMaxValue())).as("clamp(-1, MAX) & MAX = MAX").isSuccess(getMaxValue());
			}

			@Test
			void clamp_Zero_Zero() {
				var guard = initiateGuard().sanitize().clamp(getZero(), getZero()).then().build();
				GuardResultAssert.assertThat(guard.process(getMinValue())).as("clamp(0, 0) & MIN = 0").isSuccess(getZero());
				GuardResultAssert.assertThat(guard.process(getMinusOne())).as("clamp(0, 0) & -1 = 0").isSuccess(getZero());
				GuardResultAssert.assertThat(guard.process(getZero())).as("clamp(0, 0) & 0 = 0").isSuccess(getZero());
				GuardResultAssert.assertThat(guard.process(getOne())).as("clamp(0, 0) & 1 = 0").isSuccess(getZero());
				GuardResultAssert.assertThat(guard.process(getMaxValue())).as("clamp(0, 0) & MAX = 0").isSuccess(getZero());
			}

			@Test
			void clamp_Zero_One() {
				var guard = initiateGuard().sanitize().clamp(getZero(), getOne()).then().build();
				GuardResultAssert.assertThat(guard.process(getMinValue())).as("clamp(0, 1) & MIN = 0").isSuccess(getZero());
				GuardResultAssert.assertThat(guard.process(getMinusOne())).as("clamp(0, 1) & -1 = 0").isSuccess(getZero());
				GuardResultAssert.assertThat(guard.process(getZero())).as("clamp(0, 1) & 0 = 0").isSuccess(getZero());
				GuardResultAssert.assertThat(guard.process(getOne())).as("clamp(0, 1) & 1 = 1").isSuccess(getOne());
				GuardResultAssert.assertThat(guard.process(getMaxValue())).as("clamp(0, 1) & MAX = 1").isSuccess(getOne());
			}

			@Test
			void clamp_Zero_MAX() {
				var guard = initiateGuard().sanitize().clamp(getZero(), getMaxValue()).then().build();
				GuardResultAssert.assertThat(guard.process(getMinValue())).as("clamp(0, MAX) & MIN = 0").isSuccess(getZero());
				GuardResultAssert.assertThat(guard.process(getMinusOne())).as("clamp(0, MAX) & -1 = 0").isSuccess(getZero());
				GuardResultAssert.assertThat(guard.process(getZero())).as("clamp(0, MAX) & 0 = 0").isSuccess(getZero());
				GuardResultAssert.assertThat(guard.process(getOne())).as("clamp(0, MAX) & 1 = 1").isSuccess(getOne());
				GuardResultAssert.assertThat(guard.process(getMaxValue())).as("clamp(0, MAX) & MAX = MAX").isSuccess(getMaxValue());
			}

			@Test
			void clamp_One_One() {
				var guard = initiateGuard().sanitize().clamp(getOne(), getOne()).then().build();
				GuardResultAssert.assertThat(guard.process(getMinValue())).as("clamp(1, 1) & MIN = 0").isSuccess(getOne());
				GuardResultAssert.assertThat(guard.process(getMinusOne())).as("clamp(1, 1) & -1 = 0").isSuccess(getOne());
				GuardResultAssert.assertThat(guard.process(getZero())).as("clamp(1, 1) & 0 = 0").isSuccess(getOne());
				GuardResultAssert.assertThat(guard.process(getOne())).as("clamp(1, 1) & 1 = 1").isSuccess(getOne());
				GuardResultAssert.assertThat(guard.process(getMaxValue())).as("clamp(1, 1) & MAX = 1").isSuccess(getOne());
			}
			...
			void clamp_One_MAX() {
				...
				GuardResultAssert.assertThat(guard.process(getMinValue())).as("clamp(1, MAX) & MIN = 0").isSuccess(getOne());
				GuardResultAssert.assertThat(guard.process(getMinusOne())).as("clamp(1, MAX) & -1 = 0").isSuccess(getOne());
				GuardResultAssert.assertThat(guard.process(getZero())).as("clamp(1, MAX) & 0 = 0").isSuccess(getOne());
				GuardResultAssert.assertThat(guard.process(getOne())).as("clamp(1, MAX) & 1 = 1").isSuccess(getOne());
				GuardResultAssert.assertThat(guard.process(getMaxValue())).as("clamp(1, MAX) & MAX = MAX").isSuccess(getMaxValue());
			}
			...
			void clamp_MAX_MAX() {
				...
				GuardResultAssert.assertThat(guard.process(getMinValue())).as("clamp(MAX, MAX) & MIN = 0").isSuccess(getMaxValue());
				GuardResultAssert.assertThat(guard.process(getMinusOne())).as("clamp(MAX, MAX) & -1 = 0").isSuccess(getMaxValue());
				GuardResultAssert.assertThat(guard.process(getZero())).as("clamp(MAX, MAX) & 0 = 0").isSuccess(getMaxValue());
				GuardResultAssert.assertThat(guard.process(getOne())).as("clamp(MAX, MAX) & 1 = 1").isSuccess(getMaxValue());
				GuardResultAssert.assertThat(guard.process(getMaxValue())).as("clamp(MAX, MAX) & MAX = MAX").isSuccess(getMaxValue());
			}
		...
		class ClampMin {
			...
			void clampMin_MIN() {
				...
				GuardResultAssert.assertThat(guard.process(getMinValue())).as("clampMin(MIN) & MIN = MIN").isSuccess(getMinValue());
				GuardResultAssert.assertThat(guard.process(getMinusOne())).as("clampMin(MIN) & -1 = -1").isSuccess(getMinusOne());
				GuardResultAssert.assertThat(guard.process(getZero())).as("clampMin(MIN) & 0 = 0").isSuccess(getZero());
				GuardResultAssert.assertThat(guard.process(getOne())).as("clampMin(MIN) & 1 = 1").isSuccess(getOne());
				GuardResultAssert.assertThat(guard.process(getMaxValue())).as("clampMin(MIN) & MAX = MAX").isSuccess(getMaxValue());
			}

			@Test
			void clampMin_MinusOne() {
				var guard = initiateGuard().sanitize().clampMin(getMinusOne()).then().build();
				GuardResultAssert.assertThat(guard.process(getMinValue())).as("clampMin(-1) & MIN = -1").isSuccess(getMinusOne());
				GuardResultAssert.assertThat(guard.process(getMinusOne())).as("clampMin(-1) & -1 = -1").isSuccess(getMinusOne());
				GuardResultAssert.assertThat(guard.process(getZero())).as("clampMin(-1) & 0 = 0").isSuccess(getZero());
				GuardResultAssert.assertThat(guard.process(getOne())).as("clampMin(-1) & 1 = 1").isSuccess(getOne());
				GuardResultAssert.assertThat(guard.process(getMaxValue())).as("clampMin(-1) & MAX = MAX").isSuccess(getMaxValue());
			}

			@Test
			void clampMin_Zero() {
				var guard = initiateGuard().sanitize().clampMin(getZero()).then().build();
				GuardResultAssert.assertThat(guard.process(getMinValue())).as("clampMin(0) & MIN = 0").isSuccess(getZero());
				GuardResultAssert.assertThat(guard.process(getMinusOne())).as("clampMin(0) & -1 = 0").isSuccess(getZero());
				GuardResultAssert.assertThat(guard.process(getZero())).as("clampMin(0) & 0 = 0").isSuccess(getZero());
				GuardResultAssert.assertThat(guard.process(getOne())).as("clampMin(0) & 1 = 1").isSuccess(getOne());
				GuardResultAssert.assertThat(guard.process(getMaxValue())).as("clampMin(0) & MAX = MAX").isSuccess(getMaxValue());
			}

			@Test
			void clampMin_One() {
				var guard = initiateGuard().sanitize().clampMin(getOne()).then().build();
				GuardResultAssert.assertThat(guard.process(getMinValue())).as("clampMin(1) & MIN = 1").isSuccess(getOne());
				GuardResultAssert.assertThat(guard.process(getMinusOne())).as("clampMin(1) & -1 = 1").isSuccess(getOne());
				GuardResultAssert.assertThat(guard.process(getZero())).as("clampMin(1) & 0 = 1").isSuccess(getOne());
				GuardResultAssert.assertThat(guard.process(getOne())).as("clampMin(1) & 1 = 1").isSuccess(getOne());
				GuardResultAssert.assertThat(guard.process(getMaxValue())).as("clampMin(1) & MAX = 1").isSuccess(getMaxValue());
			}

			@Test
			void clampMin_MAX() {
				var guard = initiateGuard().sanitize().clampMin(getMaxValue()).then().build();
				GuardResultAssert.assertThat(guard.process(getMinValue())).as("clampMin(MAX) & MIN = MAX").isSuccess(getMaxValue());
				GuardResultAssert.assertThat(guard.process(getMinusOne())).as("clampMin(MAX) & -1 = MAX").isSuccess(getMaxValue());
				GuardResultAssert.assertThat(guard.process(getZero())).as("clampMin(MAX) & 0 = MAX").isSuccess(getMaxValue());
				GuardResultAssert.assertThat(guard.process(getOne())).as("clampMin(MAX) & 1 = MAX").isSuccess(getMaxValue());
				GuardResultAssert.assertThat(guard.process(getMaxValue())).as("clampMin(MAX) & MAX = MAX").isSuccess(getMaxValue());
			}
		...
		class ClampMax {
			...
			void clampMax_MIN() {
				...
				GuardResultAssert.assertThat(guard.process(getMinValue())).as("clampMax(MIN) & MIN = MIN").isSuccess(getMinValue());
				GuardResultAssert.assertThat(guard.process(getMinusOne())).as("clampMax(MIN) & -1 = MIN").isSuccess(getMinValue());
				GuardResultAssert.assertThat(guard.process(getZero())).as("clampMax(MIN) & 0 = MIN").isSuccess(getMinValue());
				GuardResultAssert.assertThat(guard.process(getOne())).as("clampMax(MIN) & 1 = MIN").isSuccess(getMinValue());
				GuardResultAssert.assertThat(guard.process(getMaxValue())).as("clampMax(MIN) & MAX = MIN").isSuccess(getMinValue());
			}

			@Test
			void clampMax_MinusOne() {
				var guard = initiateGuard().sanitize().clampMax(getMinusOne()).then().build();
				GuardResultAssert.assertThat(guard.process(getMinValue())).as("clampMax(-1) & MIN = MIN").isSuccess(getMinValue());
				GuardResultAssert.assertThat(guard.process(getMinusOne())).as("clampMax(-1) & -1 = -1").isSuccess(getMinusOne());
				GuardResultAssert.assertThat(guard.process(getZero())).as("clampMax(-1) & 0 = -1").isSuccess(getMinusOne());
				GuardResultAssert.assertThat(guard.process(getOne())).as("clampMax(-1) & 1 = -1").isSuccess(getMinusOne());
				GuardResultAssert.assertThat(guard.process(getMaxValue())).as("clampMax(-1) & MAX = -1").isSuccess(getMinusOne());
			}

			@Test
			void clampMax_Zero() {
				var guard = initiateGuard().sanitize().clampMax(getZero()).then().build();
				GuardResultAssert.assertThat(guard.process(getMinValue())).as("clampMax(0) & MIN = MIN").isSuccess(getMinValue());
				GuardResultAssert.assertThat(guard.process(getMinusOne())).as("clampMax(0) & -1 = -1").isSuccess(getMinusOne());
				GuardResultAssert.assertThat(guard.process(getZero())).as("clampMax(0) & 0 = 0").isSuccess(getZero());
				GuardResultAssert.assertThat(guard.process(getOne())).as("clampMax(0) & 1 = 0").isSuccess(getZero());
				GuardResultAssert.assertThat(guard.process(getMaxValue())).as("clampMax(0) & MAX = 0").isSuccess(getZero());
			}
			...
			void clampMax_One() {
				...
				GuardResultAssert.assertThat(guard.process(getMinValue())).as("clampMax(1) & MIN = MIN").isSuccess(getMinValue());
				GuardResultAssert.assertThat(guard.process(getMinusOne())).as("clampMax(1) & -1 = -1").isSuccess(getMinusOne());
				GuardResultAssert.assertThat(guard.process(getZero())).as("clampMax(1) & 0 = 0").isSuccess(getZero());
				GuardResultAssert.assertThat(guard.process(getOne())).as("clampMax(1) & 1 = 1").isSuccess(getOne());
				GuardResultAssert.assertThat(guard.process(getMaxValue())).as("clampMax(1) & MAX = 1").isSuccess(getOne());
			}

			@Test
			void clampMax_MAX() {
				var guard = initiateGuard().sanitize().clampMax(getMaxValue()).then().build();
				GuardResultAssert.assertThat(guard.process(getMinValue())).as("clampMax(MAX) & MIN = MIN").isSuccess(getMinValue());
				GuardResultAssert.assertThat(guard.process(getMinusOne())).as("clampMax(MAX) & -1 = -1").isSuccess(getMinusOne());
				GuardResultAssert.assertThat(guard.process(getZero())).as("clampMax(MAX) & 0 = 0").isSuccess(getZero());
				GuardResultAssert.assertThat(guard.process(getOne())).as("clampMax(MAX) & 1 = 1").isSuccess(getOne());
				GuardResultAssert.assertThat(guard.process(getMaxValue())).as("clampMax(MAX) & MAX = MAX").isSuccess(getMaxValue());
			}
		...
		void abs() {
			...
			GuardResultAssert.assertThat(guard.process(getMinValue())).as("abs() & MIN = -MIN").isSuccess(getAbsMinValue());
			GuardResultAssert.assertThat(guard.process(getMinusOne())).as("abs() & -1 = 1").isSuccess(getOne());
			GuardResultAssert.assertThat(guard.process(getZero())).as("abs() & 0 = 0").isSuccess(getZero());
			GuardResultAssert.assertThat(guard.process(getOne())).as("abs() & 1 = 1").isSuccess(getOne());
			GuardResultAssert.assertThat(guard.process(getMaxValue())).as("abs() & MAX = MAX").isSuccess(getMaxValue());
		}
